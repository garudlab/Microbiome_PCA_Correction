# python classifier.py --folder Gibbonsr_complete_otu --trans rel --correction nocorrection --lodo 1 --phenotype bin_crc_normal --n_estimators 100 --criterion entropy --max_depth None --min_samples_split 2 --min_samples_leaf 5 --max_features auto
