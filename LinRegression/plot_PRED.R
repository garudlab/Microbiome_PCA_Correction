...
margins_list[["Kaplanr_max_k8"]] =c(5,13)
folder_spec = list()
...
require(gplots)
nonnice_names =  c("nocorrection","DCC","combat","limma","bmc", "clr_scale","clr", "logCPM","vsd",paste0("clr_pca33",dtype_pca),pca_method_best) 
nice_names =  c("Uncorrected","DCC","ComBat","limma","BMC","CLR_Scale","CLR","logCPM","vsd","Fixed PCA Correction","Tuned PCA Correction")
